const BookDetailedInfo = (details) =>  {
    let html = `<div class="book-list__details absolute border-neutral-400 border-2 bg-white right-20 rounded-lg" style="position: absolute; width: 10vw" id="bookDetail">
